...
class _$CategoryStateTearOff {
  ...
  _Loaded loaded({required List<Meal> meals}) {
    return _Loaded(
      meals: meals,
    );
  }
...
class _$_Loaded implements _Loaded {
  const _$_Loaded({required this.meals});
  ...
  @override
  String toString() {
    return 'CategoryState.loaded(meals: $meals)';
  }
...
abstract class _Loaded implements CategoryState {
  const factory _Loaded({required List<Meal> meals}) = _$_Loaded;
