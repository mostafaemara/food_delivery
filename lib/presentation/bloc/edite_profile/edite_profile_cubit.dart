...
class EditeProfileCubit extends Cubit<EditeProfileState> {
  ...
  EditeProfileCubit(
    this._profileBloc,
  ) : super(EditeProfileState(
            isSuccess: false,
            failure: none(),
            isSubmiting: false,
            phoneNumberOrfailure: right(_profileBloc.state.profile
                .fold(() => "", (profile) => profile.phoneNumber)),
            usernameOrfailure: right(_profileBloc.state.profile
                .fold(() => "", (profile) => profile.userName))));
  ...
  void submitEdite() {
    _profileBloc.state.user.fold(() => null, (user) async {
