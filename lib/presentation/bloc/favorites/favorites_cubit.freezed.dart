...
class _$FavoritesStateTearOff {
  ...
  _Loaded loaded({required List<Meal> favorites}) {
    return _Loaded(
      favorites: favorites,
    );
  }

  _Failure failure({required ServerFailure failure}) {
    return _Failure(
      failure: failure,
    );
  }
...
mixin _$FavoritesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Meal> favorites) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<Meal> favorites)? loaded,
...
class _$_Loaded implements _Loaded {
  const _$_Loaded({required this.favorites});
...
abstract class _Loaded implements FavoritesState {
  const factory _Loaded({required List<Meal> favorites}) = _$_Loaded;
