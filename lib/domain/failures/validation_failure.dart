...
@freezed
abstract class MobilePhoneNumberValidationFailure
    with _$MobilePhoneNumberValidationFailure {
  const factory MobilePhoneNumberValidationFailure.invalid() =
      InvalidPhoneNumber;

  const factory MobilePhoneNumberValidationFailure.empty() = EmptyPhoneNumber;
}
